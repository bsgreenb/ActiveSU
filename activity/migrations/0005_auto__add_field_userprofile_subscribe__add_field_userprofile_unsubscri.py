...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('activity_userprofile', 'subscribe', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'UserProfile.unsubscribe_code'
        db.add_column('activity_userprofile', 'unsubscribe_code', self.gf('django.db.models.fields.CharField')(default=12345678901234567890123L, max_length=33), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.subscribe'
        db.delete_column('activity_userprofile', 'subscribe')

        # Deleting field 'UserProfile.unsubscribe_code'
        db.delete_column('activity_userprofile', 'unsubscribe_code')
