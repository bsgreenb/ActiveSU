...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Activity_Page.url_code'
        db.add_column('activity_activity_page', 'url_code', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Activity_Page.url_code'
        db.delete_column('activity_activity_page', 'url_code')
