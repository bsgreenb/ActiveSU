...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('activity_event_post', 'description', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Event_Post.description'
        raise RuntimeError("Cannot reverse this migration. 'Event_Post.description' and its values cannot be restored.")
