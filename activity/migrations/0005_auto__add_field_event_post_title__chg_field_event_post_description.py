...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event_Post.title'
        db.add_column('activity_event_post', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Changing field 'Event_Post.description'
        db.alter_column('activity_event_post', 'description', self.gf('django.db.models.fields.CharField')(max_length=300))


    def backwards(self, orm):
        
        # Deleting field 'Event_Post.title'
        db.delete_column('activity_event_post', 'title')

        # Changing field 'Event_Post.description'
        db.alter_column('activity_event_post', 'description', self.gf('django.db.models.fields.CharField')(max_length=500))
